const HOME_HTML = `<img src="icons/bmllogo.png" width="130" height="130" style="margin-bottom: -15px"> <p style="color: #38ac84"><i>Version 1.0.4</i></p> <h1 style="color:#faebd7">Better<span style="color: #3fcb94">ML</span></h1> <p style="color:#faebd7">A better Manyland experience.</p> <div id="turnpage" style="float: right; margin-right: -33px; padding-right: 7px; margin-top: 25px; cursor: pointer; color: #38ac84; font-size: 20px"><span style="position: absolute; font-size: 10px; right: 32px; padding-top: 5px"><i>About</i></span>→</div>`
